...
export default function DemoMobile() {
  ...
  // The Approvals screen is granted PER USER in Settings -> User access
              ...
              <div className="mob-content">
                {loading ? (
                  ...
                  <ManagerProfileTab
                    ...
                    stations={stations}
                    amountFor={amountFor}
                    onApprovals={approvalLevel ? () => setTab('approvals') : undefined}
                    onError={setError}
                  />
                ) : (
                  <ProfileTab
  ...
  return (
    <>
      ...
      <div className="mob-body">
        ...
        {awaiting.length > 0 && (
          onApprovals ? (
            <button className="mob-alert" onClick={onApprovals}>
            ...
            <div className="mob-alert">
              ⚠ {awaiting.length} record{awaiting.length === 1 ? '' : 's'} awaiting {isApprover ? 'final approval' : 'verification'}
            </div>
          )
        )}
